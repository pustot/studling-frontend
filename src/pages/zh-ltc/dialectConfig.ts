...
export const dialectConfigMap: { [key: string]: DialectConfig } = {
    ...
    'zh-wuu-sha': { // 此rime无声调
        displayName: '沪',
        link: 'https://raw.githubusercontent.com/NGLI/rime-wugniu_zaonhe/master/wugniu_zaonhe.dict.yaml',
        format: 'yaml'
    },
    ...
    'zh-wuu-wen': { // 此rime无声调
        displayName: '温',
        link: 'https://raw.githubusercontent.com/pearapple123/rime-iuciou/main/iuciou.dict.yaml',
        format: 'yaml'
    },
    'zh-cdo': { // txt 格式，非 rime 之 yaml 格式，但因主要部分以 tab 分割故暂按 yaml
        displayName: '福',
        link: 'https://raw.githubusercontent.com/only3km/ciklinbekin/master/DFDCharacters.txt',
        format: 'yaml'
    },
    'zh-cmn-shu': { // 四川话通用拼音之通音方案，依照全体四川话的「最小公倍数」音系 https://zhuanlan.zhihu.com/p/34562639
        displayName: '蜀通',
        link: 'https://raw.githubusercontent.com/Papnas/shupin/master/shupin.dict.yaml',
        format: 'yaml'
    },
